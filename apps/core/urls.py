...
from . import views
from .views import (AboutPageAPIView, FAQCategoryListAPIView, FAQListAPIView, HomePageContentAPIView, HomeView,
                    SiteContentAPIView, SiteSettingAPIView, TeamListView, TeamMemberListAPIView,
...
urlpatterns = [
    ...
    path("api/team/", TeamMemberListAPIView.as_view(), name="api_team_list"),
