...
class TeamMember(models.Model):
    ...
    photo = models.ImageField(_("Фотография"), upload_to="team_photos/", null=True, blank=True)
    ...
    department = models.ForeignKey(
        "Department", on_delete=models.SET_NULL, null=True, blank=True, verbose_name=_("Отдел")
    )
    about_page = models.ForeignKey(
        "AboutPage", on_delete=models.CASCADE, related_name="team_members", null=True, blank=True
    )
...
class Department(models.Model):
    ...
    featured_image = models.ImageField(_("Фоновое изображение"), upload_to="department_images/", null=True, blank=True)
...
class HomePageContent(models.Model):
    ...
    featured_image = models.ImageField(
        _("Изображение"), upload_to="homepage/", help_text=_("Рекомендуемый размер: 1200x800 пикселей")
    )
    services_title = models.CharField(_("Заголовок блока услуг"), max_length=100, default="Наши услуги")
    testimonials_title = models.CharField(
        _("Заголовок блока отзывов"), max_length=100, default="Отзывы наших пациентов"
    )
...
class Testimonial(models.Model):
    ...
    photo = models.ImageField(_("Фото автора"), upload_to="testimonials/", blank=True, null=True)
    rating = models.PositiveSmallIntegerField(_("Рейтинг"), choices=[(i, i) for i in range(1, 6)], default=5)
...
class FAQ(models.Model):
    ...
    category = models.ForeignKey(
        "FAQCategory", on_delete=models.SET_NULL, null=True, blank=True, verbose_name=_("Категория")
    )
    order = models.PositiveIntegerField(_("Порядок отображения"), default=0)
...
class SiteSetting(models.Model):
    ...
    logo = models.ImageField(_("Логотип"), upload_to="site_settings/", null=True, blank=True)
    favicon = models.ImageField(_("Фавикон"), upload_to="site_settings/", null=True, blank=True)
